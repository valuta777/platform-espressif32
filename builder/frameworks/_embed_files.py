            ...
            action=env.VerboseAction(
                " ".join(
                    [
                        ...
                        if mcu in ("esp32c3", "esp32c6", "esp32h4")
                        else "xtensa-%s-elf-objcopy" % mcu,
                        "--input-target",
                        "binary",
                        "--output-target",
                        "elf32-littleriscv" if mcu in ("esp32c3", "esp32c6", "esp32h4") else "elf32-xtensa-le",
                        "--binary-architecture",
                        "riscv" if mcu in ("esp32c3", "esp32c6", "esp32h4") else "xtensa",
                        "--rename-section",
